...
let currentScene = 0;
// let messages = ["Pia Pandora", "When Pia Pandora was young, she loved to swim.", "At 16, she took an interest in dancing.", "At 35, Detective Pia Pandora was on the trail of the Amazon Killer."]
// let messages = ["Pia Pandora", "As a child, she loved detective novels and solving tricky puzzles.", "At 16, she took an interest in dancing.", "At 35, Detective Pia Pandora was on the trail of the Amazon Killer."]
...
function refreshFooter() {
  if (currentScene == 0) {
  document.getElementById('title-message').textContent = 'CrossView 3D Stories';
